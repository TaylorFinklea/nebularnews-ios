...
func iconForTag(_ name: String) -> String {
    ...
    let mapping: [(keywords: [String], icon: String)] = [
        ...
        (["world news", "u.s. news", "us news", "headlines", "news"], "globe.americas"),
        (["politics", "policy", "government", "election", "legislation"], "building.columns"),
        (["consumer tech", "gadgets", "device", "devices"], "laptopcomputer.and.iphone"),
        (["health", "medicine", "wellness", "medical"], "cross.case"),
        (["sports", "athlete", "athletics", "playoff"], "sportscourt"),
        (["food", "cooking", "recipes", "recipe", "kitchen"], "fork.knife"),

...
- `[~]` **Type feed-parser properly (355 lines)**: 6 `deno-lint-ignore no-explicit-any` suppressions. Create concrete `ParsedFeed`/`ParsedItem` interfaces instead of generic objects. File: `_shared/feed-parser.ts`.
